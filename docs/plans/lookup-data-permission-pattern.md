...
export const LOOKUP_DATA_ACCESS_MAP: Record<TransactionalResource, LookupResource[]> = {
  ...
  // Sales Quotations
  sales_quotations: ["items", "customers", "employees", "item_categories"],

  // Sales Invoices
  sales_invoices: ["items", "customers", "employees", "item_categories"],
  ...
  // Purchase Receipts
  purchase_receipts: ["items", "suppliers", "warehouses", "item_categories"],
  ...
  // Stock Adjustments
  stock_adjustments: ["items", "warehouses", "item_categories"],
};
