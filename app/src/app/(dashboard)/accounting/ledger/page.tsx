        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className={`text-lg font-semibold ${getBalanceColor(ledger.openingBalance)}`}>
                    {formatCurrency(ledger.openingBalance)}
                  </div>
                </div>
                <div>
                  <div className="text-sm text-muted-foreground">Closing Balance</div>
                  <div className={`text-lg font-semibold ${getBalanceColor(ledger.closingBalance)}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className={`text-2xl font-bold ${getBalanceColor(ledger.closingBalance - ledger.openingBalance)}`}>
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow className="bg-muted/50">
                  ...
                  <TableCell className={`text-right font-mono font-semibold ${getBalanceColor(ledger.openingBalance)}`}>
                    {formatCurrency(ledger.openingBalance)}
                  </TableCell>
                </TableRow>
                ...
                {ledger.entries.length === 0 ? (
                  ...
                  ledger.entries.map((entry) => (
                    <TableRow key={entry.id}>
                      ...
                      <TableCell className="font-mono text-sm">{entry.referenceCode || '-'}</TableCell>
                      ...
                      <TableCell className={`text-right font-mono font-semibold ${getBalanceColor(entry.balance)}`}>
                ...
                <TableRow className="bg-muted/50 font-bold">
                  ...
                  <TableCell className="text-right font-mono">{formatCurrency(ledger.totalDebits)}</TableCell>
                  <TableCell className="text-right font-mono">{formatCurrency(ledger.totalCredits)}</TableCell>
                  <TableCell className={`text-right font-mono font-semibold ${getBalanceColor(ledger.closingBalance)}`}>
                    {formatCurrency(ledger.closingBalance)}
                  </TableCell>
                </TableRow>
              </TableBody>
