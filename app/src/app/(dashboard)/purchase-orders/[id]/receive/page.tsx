...
const mockItems = [
  { id: '1', itemCode: 'ITM-001', itemName: 'Product A', orderedQty: 100, receivedQty: 0, uom: 'pcs' },
  { id: '2', itemCode: 'ITM-002', itemName: 'Product B', orderedQty: 50, receivedQty: 0, uom: 'box' },
  { id: '3', itemCode: 'ITM-003', itemName: 'Product C', orderedQty: 200, receivedQty: 0, uom: 'pcs' },
];
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="flex gap-2 pt-6">
            <Button
              onClick={() => {
                alert('Receiving completed! This would create a purchase receipt and update stock levels.');
