...
export const RESOURCE_METADATA: ResourceMetadata[] = [
  ...
  {
    key: RESOURCES.MANAGE_LOCATIONS,
    name: 'Location Management',
    description: 'Create and maintain warehouse locations',
    category: 'Inventory',
  },
  {
    key: RESOURCES.VIEW_LOCATION_STOCK,
    name: 'Location Stock',
    description: 'View stock by warehouse location',
    category: 'Inventory',
  },
  {
    key: RESOURCES.TRANSFER_BETWEEN_LOCATIONS,
