...
export function ReceiveStockRequestDialog({
  ...
  const onSubmit = async (data: ReceiveStockRequestFormValues) => {
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : "Failed to receive stock request";
      toast.error(message);
    }
  };
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-2 gap-4 p-4 bg-muted rounded-lg">
              ...
              <div>
                ...
                <div className="font-medium capitalize">{stockRequest.status.replace(/_/g, " ")}</div>
              </div>
            </div>
                          ...
                          <TableCell>
                            ...
                            >
                              <SelectTrigger className="h-9">
                                <SelectValue
                                  placeholder={
                                    receivingWarehouseId ? "Select location" : "Select warehouse first"
                                  }
                                />
                              </SelectTrigger>
                              <SelectContent>
