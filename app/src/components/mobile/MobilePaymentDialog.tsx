          ...
          <Card className="p-3 bg-gray-50">
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className={totalPayments > totalAmount ? "text-red-600 font-semibold" : "font-semibold"}>
                  ₱{totalPayments.toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between border-t pt-2">
                <span>Remaining:</span>
                <span className={`font-bold ${remaining > 0.01 ? "text-orange-600" : remaining < -0.01 ? "text-red-600" : "text-green-600"}`}>
                  ₱{remaining.toFixed(2)}
                </span>
              </div>
            </div>
          ...
          {!isValid && (
            <div className="text-sm text-center">
              ...
              {payments.some(p => p.amount <= 0) && (
                <Badge variant="destructive" className="w-full py-2 mt-2">
