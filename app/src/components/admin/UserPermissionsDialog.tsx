...
import { Key, Loader2, Search, Shield, Eye, Plus, Edit, Trash2 } from "lucide-react";
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className="text-center">
                          {permission.can_view ? (
                            <Badge variant="outline" className="bg-green-50 border-green-600 text-green-700 dark:bg-green-950 dark:border-green-400 dark:text-green-400">
                              ✓
                            </Badge>
                          ) : (
                        ...
                        <TableCell className="text-center">
                          {permission.can_create ? (
                            <Badge variant="outline" className="bg-blue-50 border-blue-600 text-blue-700 dark:bg-blue-950 dark:border-blue-400 dark:text-blue-400">
                              ✓
                            </Badge>
                          ) : (
                            <span className="text-muted-foreground">-</span>
                        ...
                        <TableCell className="text-center">
                          {permission.can_edit ? (
                            <Badge variant="outline" className="bg-yellow-50 border-yellow-600 text-yellow-700 dark:bg-yellow-950 dark:border-yellow-400 dark:text-yellow-400">
                              ✓
                            </Badge>
                          ) : (
                            <span className="text-muted-foreground">-</span>
                        ...
                        <TableCell className="text-center">
                          {permission.can_delete ? (
                            <Badge variant="outline" className="bg-red-50 border-red-600 text-red-700 dark:bg-red-950 dark:border-red-400 dark:text-red-400">
                              ✓
                            </Badge>
                          ) : (
                            <span className="text-muted-foreground">-</span>
