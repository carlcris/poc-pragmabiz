...
export const StatusBadge = ({ status, variant = 'default' }: StatusBadgeProps) => {
  const statusConfig: Record<string, { label: string; variant: typeof variant; className?: string }> = {
    draft: { label: 'Draft', variant: 'outline', className: 'border-gray-400 text-gray-600' },
    submitted: { label: 'Submitted', variant: 'outline', className: 'border-blue-400 text-blue-600' },
    ...
    partially_received: { label: 'Partially Received', variant: 'default', className: 'bg-orange-600' },
  };
