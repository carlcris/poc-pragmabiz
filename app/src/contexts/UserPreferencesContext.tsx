...
import type { UserPreferences, FontSize, Theme, UpdateUserPreferencesRequest } from '@/types/user-preferences'
...
export function UserPreferencesProvider({ children }: { children: React.ReactNode }) {
  ...
  const updatePreferences = useCallback(async (updates: UpdateUserPreferencesRequest) => {
    try {
      const response = await fetch('/api/user-preferences', {
        method: 'PUT',
        headers: {
