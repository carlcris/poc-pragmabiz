...
export type StockRequestPriority =
  | 'low'
  | 'normal'
  | 'high'
  | 'urgent';
...
export interface UpdateStockRequestPayload extends Partial<CreateStockRequestPayload> {
  // id is passed separately to the API, not in the payload
}
