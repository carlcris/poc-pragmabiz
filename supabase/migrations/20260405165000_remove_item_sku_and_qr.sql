-- ============================================================================
-- Migration: Remove legacy item SKU columns
-- Version: 20260405165000
-- Description: Removes items.sku and items.sku_qr_image in favor of
--              base item-unit-option barcodes and updates item RPC search.
-- Date: 2026-04-05
-- ============================================================================
...
ALTER TABLE public.items DROP COLUMN IF EXISTS sku_qr_image;
DROP INDEX IF EXISTS public.idx_items_company_sku;
ALTER TABLE public.items DROP CONSTRAINT IF EXISTS items_sku_check;
