-- Migration: Use configured item_warehouse.max_quantity for item overstock status.
-- Date: 2026-05-08

BEGIN;

COMMENT ON COLUMN public.item_warehouse.max_quantity IS
  'Maximum desired stock quantity for this item in this warehouse. Values above this threshold are treated as overstock.';

ALTER TABLE public.item_warehouse
  DROP CONSTRAINT IF EXISTS chk_item_warehouse_max_quantity_non_negative,
  ADD CONSTRAINT chk_item_warehouse_max_quantity_non_negative
