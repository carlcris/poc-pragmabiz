...
DROP TRIGGER IF EXISTS trigger_apply_grn_stock_transaction_item_costs
  ON public.stock_transaction_items;
DROP FUNCTION IF EXISTS public.apply_grn_stock_transaction_item_costs();
...
BEGIN
  ...
  LOOP
    ...
    SELECT
      i.uom_id,
      COALESCE(NULLIF(lli.unit_price, 0), NULLIF(i.cost_price, 0), NULLIF(i.purchase_price, 0), 0)
