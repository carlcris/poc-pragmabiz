  ...
  const { data: salesData, isLoading: salesLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const avgTransactionValue =
        result.transactions > 0 ? result.todaySales / result.transactions : 0;
  ...
  if (vanLoading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <MobileHeader title="Sales Summary" showBack backHref="/mobile/reports" />
        <div className="p-4">
          ...
          <>
            ...
            <Card className="border-l-4 border-l-green-500">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="mb-1 text-sm text-gray-600">Total Sales</div>
            ...
            <Card className="border-l-4 border-l-blue-500">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="mb-1 text-sm text-gray-600">Transactions</div>
                    <div className="text-2xl font-bold text-blue-600">{summary.transactions}</div>
                  </div>
            ...
            <Card className="border-l-4 border-l-purple-500">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="mb-1 text-sm text-gray-600">Items Sold</div>
                    <div className="text-2xl font-bold text-purple-600">{summary.itemsSold}</div>
                  </div>
            ...
            <Card className="border-l-4 border-l-orange-500">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="mb-1 text-sm text-gray-600">Avg. Transaction Value</div>
                    <div className="text-2xl font-bold text-orange-600">
                      ₱
                      {summary.averageTransactionValue.toLocaleString("en-US", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                    </div>
                ...
                <CardContent className="p-4 text-center">
                  ...
                  {summary.transactions > 0 && (
                    <p className="mt-2 text-sm text-gray-600">
                      You made {summary.transactions}{" "}
                      {summary.transactions === 1 ? "sale" : "sales"} today
                    </p>
                  )}
                </CardContent>
              </Card>
