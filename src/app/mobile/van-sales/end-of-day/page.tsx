...
export default function EndOfDayPage() {
  ...
  const updateCount = (itemId: string, countedQty: number) => {
    setAdjustmentItems(
      adjustmentItems.map((item) => (item.itemId === itemId ? { ...item, countedQty } : item))
    );
  };
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-base">
                  Count List ({adjustmentItems.length} items)
                </CardTitle>
                ...
                return (
                  <div
                    ...
                    className={`flex items-center gap-3 rounded-lg p-3 ${
                      hasDifference ? "border-2 border-orange-500 bg-orange-50" : "bg-gray-50"
                    }`}
                  >
                    <div className="flex-1">
                      <p className="text-sm font-medium">{item.itemName}</p>
                      <p className="text-xs text-gray-500">
                        System: {item.currentStock} {item.uomName}
                      </p>
                      {hasDifference && (
                        <p
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Input
                        ...
                        className="h-8 w-16 p-0 text-center font-bold"
                      />
                      <Button
                        size="sm"
                        variant="outline"
              ...
              <div className="space-y-3 text-center">
                ...
                <p className="text-sm text-gray-500">
                  {searchTerm
                    ...
                    : "Use the search box above to find items to count"}
                </p>
              </div>
            </CardContent>
          </Card>
