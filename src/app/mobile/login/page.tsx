...
export default function MobileLoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary/5 via-white to-primary/5 p-4">
      <div className="w-full max-w-md">
        {/* Logo/Brand */}
        <div className="mb-8 text-center">
          <div className="mb-4 inline-flex h-20 w-20 items-center justify-center">
            <Image src={erpLogo} alt="ERP Logo" width={80} height={80} className="object-contain" />
          </div>
          <h1 className="mb-2 text-3xl font-bold text-primary">PragmaBiz</h1>
        </div>
        ...
        <Card className="shadow-2xl">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Sign in to start selling</CardDescription>
          </CardHeader>
          <CardContent>
