...
import { Package, ArrowRightLeft, TrendingUp, FileText, ChevronRight } from "lucide-react";
...
export default function PackageConversionsReportPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Package Conversion Audit</h1>
      ...
      {reportData && (
        <>
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">With Package Conversion</CardTitle>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Base Package Only</CardTitle>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Avg Conversion Factor</CardTitle>
          ...
          {reportData.packageBreakdown.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Summary of conversions by package type</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                  ...
                  <TableBody>
                    ...
                    {reportData.data.map((txn) => (
                      <TableRow key={txn.id}>
                        ...
                        <TableCell>
                          <div>
                            <div className="text-sm font-medium">{txn.transactionCode}</div>
                        ...
                        <TableCell>
                          <div>
                            <div className="text-sm font-medium">{txn.item.code}</div>
                            <div className="text-xs text-muted-foreground">{txn.item.name}</div>
                          </div>
                        </TableCell>
                        <TableCell>
                          <div className="text-sm">{txn.warehouse.code}</div>
                        </TableCell>
                        <TableCell className="text-right font-medium">
                        ...
                        <TableCell>
                          {txn.inputPackage ? (
                            <div>
                              <div className="text-sm font-medium">{txn.inputPackage.name}</div>
                              <div className="text-xs text-muted-foreground">
                        ...
                        <TableCell className="text-center">
                          {txn.usedConversion ? (
                            ...
                            <span className="text-xs text-muted-foreground">1.00x</span>
                          )}
                        </TableCell>
                        <TableCell className="text-right font-medium">
                        ...
                        <TableCell>
                          {txn.basePackage && <div className="text-sm">{txn.basePackage.name}</div>}
                        </TableCell>
                        <TableCell className="text-right">
              ...
              {reportData.pagination && (
                <div className="mt-4 flex items-center justify-between">
                  <div className="text-sm text-muted-foreground">
                    Showing {offset + 1} to {Math.min(offset + limit, reportData.pagination.total)}{" "}
                    of {reportData.pagination.total.toLocaleString()} transactions
                  </div>
