...
export default function SalesAnalyticsPage() {
  ...
  const analyticsFilters = useMemo<SalesAnalyticsFilters>(() => {
    ...
    if (regionState) filters.regionState = regionState;
    return filters;
    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        <AnalyticsFilters
          ...
          onEmployeeChange={(value) => setEmployeeId(value === "all" ? undefined : value)}
          city={city}
          onCityChange={(value) => setCity(value === "all" ? undefined : value)}
          regionState={regionState}
          onRegionChange={(value) => setRegionState(value === "all" ? undefined : value)}
          onReset={handleReset}
        />
      </Card>
