...
export default function StockRequestPickPage() {
  ...
  const handlePickedQtyChange = (itemId: string, qty: number) => {
    setItems(items.map((item) => (item.id === itemId ? { ...item, pickedQty: qty } : item)));
  };
        ...
        <CardContent>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                handlePickedQtyChange(item.id, Number(e.target.value))
                              }
                              className="w-24"
                            />
          ...
          <div className="flex gap-2 pt-6">
            <Button
              onClick={() => {
                alert(
                  "Picking completed! This would save the picked quantities and update the request status."
                );
                router.back();
              }}
