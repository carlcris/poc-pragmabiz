...
export default function CustomerDisplayPage() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-background">
      ...
      <div className="flex h-full w-2/3 flex-col border-r-4 border-border bg-background">
        {/* Header */}
          ...
          {cart.length === 0 ? (
            <div className="flex flex-1 items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-4xl font-medium text-muted-foreground">Waiting for items...</p>
              </div>
            </div>
          ) : (
            <>
              {/* Table Header */}
              <div className="mb-4 grid grid-cols-12 gap-4 border-b-2 border-border pb-3 text-lg font-semibold text-muted-foreground">
              ...
              <div className="flex-1 space-y-2 overflow-y-auto">
                {cart.map((item, index) => (
                  <div
                    key={item.id + index}
                    className="grid grid-cols-12 items-center gap-4 border-b border-border py-3"
                  >
                    ...
                    <div className="col-span-5">
                      <p className="text-2xl font-medium text-foreground">{item.name}</p>
                    </div>
                    <div className="col-span-2 text-center">
                      <span className="text-2xl font-bold text-primary">{item.quantity}</span>
                    </div>
                    <div className="col-span-2 text-right">
                      <p className="text-xl text-muted-foreground">{formatCurrency(item.price)}</p>
                    </div>
                    <div className="col-span-2 text-right">
        ...
        {cart.length > 0 && (
          <div className="border-t-4 border-border bg-muted/50 p-8">
            <div className="ml-auto max-w-md space-y-3">
              ...
              {discount > 0 && (
                <div className="flex items-center justify-between text-2xl text-destructive">
                  <span>Discount</span>
              ...
              <div className="flex items-center justify-between border-t-2 border-border pt-3 text-2xl">
      ...
      <div className="flex h-full w-1/3 flex-col justify-evenly overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/10 p-8">
        {/* Ad 1 - Gift Card */}
        <div className="w-full py-6 text-center">
          <div className="mb-4 text-7xl">🎁</div>
          <h2 className="mb-3 text-4xl font-black tracking-tight text-primary">Gift Cards</h2>
          <p className="mb-6 text-xl text-muted-foreground">Perfect for any occasion</p>
          <div className="inline-block">
            <p className="mb-1 text-lg text-muted-foreground">Starting from</p>
        ...
        <div className="w-full py-6 text-center">
          <div className="mb-4 text-7xl">🥬</div>
          <h3 className="mb-3 bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-4xl font-black tracking-tight text-transparent">
            Fresh Daily
          </h3>
        ...
        <div className="w-full py-6 text-center">
          <div className="mb-4 text-7xl">⭐</div>
          <h3 className="mb-3 text-4xl font-black tracking-tight text-foreground">
            Rewards Program
          </h3>
