...
function transformDbCustomer(dbCustomer: DbCustomer): Customer {
  return {
    ...
    customerType: dbCustomer.customer_type as "individual" | "company" | "government",
    ...
    billingAddress:
      `${dbCustomer.billing_address_line1 || ""}${dbCustomer.billing_address_line2 ? " " + dbCustomer.billing_address_line2 : ""}`.trim(),
    ...
    shippingAddress:
      `${dbCustomer.shipping_address_line1 || ""}${dbCustomer.shipping_address_line2 ? " " + dbCustomer.shipping_address_line2 : ""}`.trim(),
...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    if (body.billingPostalCode !== undefined)
      updateData.billing_postal_code = body.billingPostalCode;
    ...
    if (body.shippingPostalCode !== undefined)
      updateData.shipping_postal_code = body.shippingPostalCode;
