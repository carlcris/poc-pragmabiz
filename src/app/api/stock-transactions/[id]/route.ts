    ...
    const formattedTransaction = {
      ...
      items: typedItems.map((item) => ({
        ...
        stockValueBefore: item.stock_value_before
          ...
          : null,
        stockValueAfter: item.stock_value_after ? parseFloat(String(item.stock_value_after)) : null,
      ...
      createdByName: transaction.creator
        ? `${transaction.creator.first_name || ""} ${transaction.creator.last_name || ""}`.trim() ||
          "Unknown"
        : "Unknown",
