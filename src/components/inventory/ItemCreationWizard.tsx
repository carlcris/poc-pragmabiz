...
import {
  useCreateItemWithPackages,
  type CreateItemWithPackagesInput,
} from "@/hooks/useCreateItemWithPackages";
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        {currentStep === "basic" && <BasicInfoStep formData={formData} setFormData={setFormData} />}
        ...
        {createItem.isError && (
          <div className="mt-4 rounded-md border border-red-200 bg-red-50 p-4">
            <p className="text-sm text-red-600">Failed to create item. Please try again.</p>
          </div>
        )}
      </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          This defines the base unit for storing inventory. All quantities will be converted to this
          unit.
        </p>
      </div>
      ...
      <div className="rounded-md border border-blue-200 bg-blue-50 p-4">
        <p className="text-sm text-blue-800">
          <strong>Important:</strong> The base package always has a conversion factor of 1.0. All
          other packages will be defined relative to this unit.
        </p>
      </div>
...
function AdditionalPackagesStep({
  ...
  return (
    <div className="space-y-6">
      ...
      <button
        onClick={addPackage}
        className="w-full rounded-md border border-blue-200 bg-blue-50 px-4 py-2 text-sm text-blue-600 hover:bg-blue-100"
      >
        + Add Package
      </button>
    </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {/* Base Package */}
        <div className="rounded-md border border-blue-200 bg-blue-50 p-4">
          <h4 className="mb-3 text-sm font-medium text-gray-900">Base Package (Storage Unit)</h4>
          <dl className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
        ...
        {formData.additionalPackages && formData.additionalPackages.length > 0 && (
          <div className="rounded-md border border-gray-200 bg-gray-50 p-4">
            ...
            <div className="space-y-2">
              {formData.additionalPackages.map((pkg, index) => (
                <div key={index} className="rounded border border-gray-200 bg-white p-2 text-sm">
