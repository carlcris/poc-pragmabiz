...
export type TransactionalResource =
  ...
  | typeof RESOURCES.DELIVERY_NOTES
  | typeof RESOURCES.PICK_LISTS
...
export const LOOKUP_DATA_ACCESS_MAP: Record<TransactionalResource, LookupResource[]> = {
  ...
  [RESOURCES.DELIVERY_NOTES]: [RESOURCES.ITEMS, RESOURCES.WAREHOUSES, RESOURCES.ITEM_CATEGORIES],

  [RESOURCES.PICK_LISTS]: [RESOURCES.ITEMS, RESOURCES.WAREHOUSES, RESOURCES.ITEM_CATEGORIES],
