...
export const translations: Record<Locale, TranslationKeys> = {
  en: {
    ...
    grnsPage: {
      ...
      submitTitle: "Submit GRN for Approval",
      submitDescription: "Submit {grnNumber} for approval?",
      submitting: "Submitting...",
      ...
      approveDescription:
        "Are you sure you want to approve {grnNumber}? This will create inventory records and update stock levels. This action cannot be undone.",
      approving: "Approving...",
      approveSuccess: "GRN approved successfully",
      approveError: "Failed to approve GRN",
      reject: "Reject",
      rejectTitle: "Reject GRN",
      rejectDescription: "Are you sure you want to reject {grnNumber}? Please provide a reason.",
  ...
  zh: {
    ...
    grnsPage: {
      ...
      submitTitle: "提交收货单审批",
      submitDescription: "提交 {grnNumber} 审批？",
      submitting: "提交中...",
