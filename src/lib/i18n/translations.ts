...
export const translations: Record<Locale, TranslationKeys> = {
  ...
  es: {
    ...
    transformation: {
      ...
      completeConfirmation:
        "Esto completará la transformación, consumiendo los materiales de entrada y produciendo los productos de salida.",
      ...
      enterActualQuantities:
        "Ingrese las cantidades reales de insumos consumidos y productos producidos",
  ...
  fr: {
    ...
    transformation: {
      ...
      completeConfirmation:
        "Cela terminera la transformation, en consommant les matériaux d'entrée et en produisant les produits de sortie.",
      ...
      enterActualQuantities:
        "Entrez les quantités réelles des intrants consommés et des produits fabriqués",
  ...
  de: {
    ...
    transformation: {
      ...
      completeConfirmation:
        "Dies wird die Transformation abschließen, die Eingangsmaterialien verbrauchen und die Ausgangsprodukte produzieren.",
      cancelConfirmation:
        "Dies wird den Auftrag stornieren. Diese Aktion kann nicht rückgängig gemacht werden.",
      ...
      enterActualQuantities:
        "Geben Sie die tatsächlichen Mengen für verbrauchte Eingänge und produzierte Ausgänge ein",
  ...
  ja: {
    ...
    transformation: {
      ...
      cancelConfirmation:
        "これにより注文がキャンセルされます。この操作は元に戻すことができません。",
