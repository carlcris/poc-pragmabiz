...
export const translations: Record<Locale, TranslationKeys> = {
  en: {
    ...
    adminSettings: {
      ...
      workflowForm: {
        ...
        stockRequestRequireApprovalDescription: "Stock transfers require approval before processing",
    ...
    reorderManagementPage: {
      ...
      seasonEffectiveDateInvalid: "Effective from date must be before or equal to effective to date",
      ...
      addPolicyEmptyHint:
        'Click "Add Policy" above to create reorder overrides for this season',
      save: "Save",
      edit: "Edit",
      close: "Close",
  ...
  zh: {
    ...
    reorderManagementPage: {
      ...
      seasonalItemPoliciesDescription: "为季节设置按商品的补货覆盖值。停用的策略会回退到商品默认值。",
      selectSeason: "选择季节",
      selectItem: "选择商品",
      searchItems: "搜索商品",
      noItemsFound: "未找到商品",
    ...
    grnsPage: {
      ...
      confirm: "确认收货",
      confirmTitle: "确认收货单",
      confirmDescription: "确定要确认 {grnNumber} 吗？这将确认已暂存到上架区的收货库存。此操作无法撤销。",
      confirming: "确认中...",
