...
export type TranslationKeys = {
  ...
  purchaseOnOrderPage: Record<string, string>;
  ...
  customerLedgerReportsPage: Record<string, string>;
  accountsReceivableAgingReportPage: Record<string, string>;
...
export const translations: Record<Locale, TranslationKeys> = {
  en: {
    ...
    navigation: {
      ...
      "stock-requests": "Stock Transfers",
      "delivery-notes": "Delivery Notes",
      "pick-lists": "Pick Lists",
    ...
    adminSettings: {
      ...
      workflowForm: {
        ...
        stockRequestApprovalTitle: "Stock Transfer Approval",
        stockRequestApprovalDescription: "Configure approval workflows for stock transfers",
        stockRequestRequireApprovalDescription:
          "Stock transfers require approval before processing",
        stockRequestApprovalThresholdDescription:
          "Require approval for stock transfers above this value",
    ...
    posPage: {
      ...
      searchPlaceholder: "Search customers by code or name...",
    ...
    deliveryNotesPage: {
      ...
      inventoryAvailabilityLoading: "Please wait for inventory availability to finish loading.",
      inventoryAvailabilityError:
        "Unable to load complete inventory availability. Retry before creating the delivery note.",
      retryInventoryAvailability: "Retry",
      ...
      helperName: "Helper",
      enterHelperName: "Enter helper name",
    ...
    deliveryNoteDetailPage: {
      ...
      addItems: "Add Items",
      addItemsDescription:
        "Add allocatable stock transfer items to this delivery note and create a new pick list.",
      ...
      searchItems: "Search stock transfers or items...",
      noAllocatableItems: "No allocatable stock transfer items available.",
    ...
    reorderManagementPage: {
      ...
      activeAlertsSubTab: "Active ({count})",
      acknowledgedAlertsSubTab: "Acknowledged ({count})",
      ...
      createStockRequisition: "Create Stock Requisition",
      reorderAlertLineNote: "Created from reorder alert",
      severity: "Severity",
      item: "Item",
      ...
      acknowledgedAlertsDescription:
        "Acknowledged alerts will appear here while their alert condition remains active.",
      ...
      unacknowledge: "Restore Alert",
      acknowledgedAt: "Acknowledged At",
      notAvailable: "N/A",
      seasonOverrideSource: "{season} override",
      itemDefaultSource: "Item default",
      seasonConfiguration: "Season Configuration",
      seasonConfigurationDescription:
        "Define date-effective reorder seasons. Active seasons are selected automatically by date.",
      ...
      createNewSeasonDescription:
        "Define a seasonal period with custom reorder rules for specific items.",
      seasonCodePlaceholder: "e.g., SUMMER2024",
      seasonCodeHelp: "A unique identifier for this season",
      seasonNamePlaceholder: "e.g., Summer Season 2024",
      seasonNameHelp: "A descriptive name for this season",
      effectiveFromHelp: "Start date for this season",
      effectiveToHelp: "End date for this season",
      priorityHelp: "Higher priority seasons take precedence",
      seasonActiveHelp: "Only active seasons will apply reorder rules",
      cancel: "Cancel",
      creating: "Creating...",
      createSeason: "Create Season",
      seasonCodeAndNameRequired: "Season code and name are required",
      seasonEffectiveDateInvalid:
        "Effective from date must be before or equal to effective to date",
      seasonPriorityInvalid: "Priority must be a non-negative number",
      season: "Season",
      effectiveDates: "Effective Dates",
      itemsOverridden: "Items Overridden",
      actions: "Actions",
      status: "Status",
      loading: "Loading",
      loadingSeasons: "Loading seasons...",
      noSeasons: "No reorder seasons configured",
      noSeasonsConfigured: "No seasons configured. Create your first season above.",
      deleteSeason: "Delete season",
      deleteSeasonConfirm:
        'Are you sure you want to delete "{name}"? This will also delete all associated item policies.',
      seasonalReorderRules: "Seasonal reorder rules",
      seasonalReorderRulesDescription:
        "Manage seasons and their per-item reorder overrides in one place.",
      newSeason: "New Season",
      managePolicies: "Manage policies",
      seasonPolicyItemCount: "{count, plural, one {# item} other {# items}}",
      seasonalItemPolicies: "Seasonal Item Policies",
      seasonalItemPoliciesDescription:
        "Set per-item reorder overrides for a season. Inactive policies fall back to item defaults.",
      selectSeason: "Select season",
      selectItem: "Select item",
      searchItems: "Search items",
      noItemsFound: "No items found",
      seasonItemPolicyTitle: "{seasonName} - Item Reorder Policies",
      seasonItemPolicySubtitle: "{seasonCode} - {effectiveFrom} to {effectiveTo}",
      reorderLevel: "Reorder Level",
      reorderLevelPlaceholder: "e.g., 50",
      reorderQty: "Reorder Qty",
      reorderQuantityPlaceholder: "e.g., 100",
      reorderQuantity: "Reorder Quantity",
      unit: "Unit",
      selectUnit: "Select unit",
      qtyPerUnit: "Qty/Unit",
      baseReorderLevel: "Base reorder level",
      totalQty: "Total Qty",
      activeOnCreation: "Active on creation",
      ...
      clear: "Clear",
      clearFilters: "Clear Filters",
      policyResultsCount: "Showing {filtered} of {total} policies",
      policyTotalCount: "{count, plural, one {# policy total} other {# policies total}}",
      noMatchingPolicies: "No matching policies found",
      adjustPolicyFilters: "Try adjusting your search or filters",
      noItemPoliciesDefined: "No item policies defined",
      addPolicyEmptyHint: 'Click "Add Policy" above to create reorder overrides for this season',
      save: "Save",
      edit: "Edit",
      close: "Close",
      policyRequiredFieldsInvalid: "Please fill in all required fields with valid values",
      policyQuantityInvalid: "Reorder level must be non-negative and quantity must be positive",
      reorderLevelInvalid: "Reorder level must be a non-negative number",
      reorderQuantityInvalid: "Reorder quantity must be a positive number",
      policyUpdateFailed: "Failed to update policy",
      policyDeleteFailed: "Failed to delete policy",
      deleteItemPolicyConfirm: "Are you sure you want to delete this item policy?",
      noPolicies: "No seasonal item policies configured",
      deletePolicy: "Delete policy",
      seasonCreated: "Reorder season created",
      seasonCreateFailed: "Failed to create reorder season",
      policyCreated: "Seasonal reorder policy created",
      policyCreateFailed: "Failed to create seasonal reorder policy",
      seasonAndItemRequired: "Select a season and item first",
    },
    ...
    purchasingOverviewWidgets: {
      ...
      pendingApprovalsTitle: "Pending Confirmations",
      grnsAwaitingApproval: "GRNs awaiting confirmation",
      failedLoadPendingApprovals: "Failed to load pending confirmations",
      allCaughtUp: "All caught up!",
      noGrnsAwaitingApproval: "No GRNs awaiting confirmation",
      overdueGrnsAlert: "{count} GRNs have been pending for more than 24 hours",
      awaitingApprovalLabel: "Awaiting Confirmation",
      grns: "GRNs",
      loadList: "Load List",
    ...
    purchaseOnOrderPage: {
      title: "On Order",
      subtitle: "Items still pending from suppliers",
      searchPlaceholder: "Search supplier, SR number, item code, or item name...",
      statusPlaceholder: "Status",
      supplierPlaceholder: "Supplier",
      allStatus: "All Status",
      allSuppliers: "All Suppliers",
      ...
      clearSupplier: "Clear supplier filter",
      ...
      expectedDelivery: "Expected Delivery",
      expectedFrom: "Expected delivery from",
      expectedTo: "Expected delivery to",
      status: "Status",
      actions: "Actions",
      view: "View",
    ...
    reportsPage: {
      ...
      previewRowCount: "{count} rows ready for preview",
      ...
      fastMovingProductsValue: "Better replenishment focus and demand visibility",
      slowMovingProductsName: "Slow Moving Products",
      slowMovingProductsDescription:
        "Identify stocked products with low or zero sales movement during the selected period",
      slowMovingProductsValue: "Reduce dead stock and working-capital drag",
      ...
      customerLedgerName: "Customer Ledger",
      customerLedgerDescription:
        "Customer account statement with invoices, payments, POS activity, and running balance",
      customerLedgerValue: "Accurate customer balance and collection visibility",
    ...
    inventoryReportPage: {
      ...
      subtitle:
        "Warehouse stock balances by item, category, status, and warehouse within the current business unit.",
      filters: "Filters",
      itemSearch: "Item Search",
      searchPlaceholder: "Search item code or item name...",
      warehouse: "Warehouse",
      selectWarehouse: "Select warehouse",
      category: "Category",
      ...
      inventoryRowsDescription: "Matching item-warehouse balances.",
      qtyOnHand: "Qty On Hand",
      ...
      unknown: "Unknown",
      reset: "Reset",
      loadError: "Failed to load inventory report.",
      exportPdf: "Export PDF",
    ...
    productMovementReportsPage: {
      fastTitle: "Fast Moving Products",
      fastSubtitle:
        "Products ranked by sold quantity, sales velocity, and revenue within the selected period.",
      slowTitle: "Slow Moving Products",
      slowSubtitle: "Stocked products ranked by low or zero movement within the selected period.",
      search: "Search",
      searchPlaceholder: "Search item code, item name, or category...",
      startDate: "Start Date",
      endDate: "End Date",
      period: "Period",
      category: "Category",
      ...
      stock: "Stock",
      stockValue: "Stock Value",
      stockValueAtRisk: "Stock Value at Risk",
      daysCover: "Cover",
      lastSold: "Last Sold",
      totalProducts: "Products",
      totalQtySold: "Total Sold",
      totalRevenue: "Total Revenue",
      averageVelocity: "Avg Velocity",
      pageOfTotal: "Page {page} of {totalPages} • {total} products",
      noValue: "--",
    },
    salesAnalyticsPage: {
    ...
    customerLedgerReportsPage: {
      title: "Customer Ledger Report",
      subtitle: "Review customer account activity, payments, POS sales, and running balances",
      filtersTitle: "Report Filters",
      filtersDescription: "Select a customer and refine the ledger period or source type.",
      ...
      endDate: "End Date",
      period: "Period",
      pageOfTotal: "Page {page} of {totalPages} • {total} rows",
      selected: "Selected",
      ...
      closingBalance: "Closing Balance",
      chargesCaption: "Invoices and paid POS sales",
      creditsCaption: "Payments and POS settlement",
      activeInvoicesCaption: "{count} active invoices",
      ledgerTitle: "Ledger Entries",
      ledgerSearchPlaceholder: "Search document, method, or reference...",
      selectCustomerTitle: "Select a customer to generate the ledger",
      selectCustomerDescription:
        "The report loads only the selected customer's ledger entries with server-side filters.",
      loadErrorTitle: "Unable to load customer ledger",
      loadErrorDescription: "Please refresh and try again.",
      emptyTitle: "No ledger activity found",
      emptyDescription: "Try adjusting the customer, date, source, or search filters.",
      date: "Date",
      source: "Source",
      document: "Document",
      description: "Description",
      ...
      balance: "Balance",
      referencePrefix: "Ref",
      refreshing: "Refreshing ledger...",
    },
    accountsReceivableAgingReportPage: {
      title: "Accounts Receivable Aging",
      subtitle: "Open customer invoice balances grouped by aging bucket as of a selected date",
      asOfDate: "As Of Date",
      customer: "Customer",
      ...
      days90Plus: "90+",
      search: "Search",
      searchPlaceholder: "Search invoice, customer code, or customer name...",
      customers: "Customers",
      invoices: "Invoices",
      totalBalance: "Total AR",
      invoiceDate: "Invoice Date",
      dueDate: "Due Date",
      daysOverdue: "Days",
      balance: "Balance",
      pageOfTotal: "Page {page} of {totalPages} • {total} invoices",
    },
    commissionSummary: {
    ...
    loadListsPage: {
      ...
      cancelDescription: "Are you sure you want to cancel {code}? This action cannot be undone.",
      cancelBack: "No, go back",
      cancelling: "Cancelling...",
      confirmCancel: "Yes, cancel",
      cancelSuccess: "Load List cancelled successfully",
      cancelError: "Failed to cancel load list",
      deleting: "Deleting...",
    ...
    linkStockRequisitionsDialog: {
      ...
      searchPlaceholder: "Search by requisition number, item code, or item name",
      loading: "Loading eligible requisition items...",
      previous: "Previous",
      next: "Next",
      pageOfTotal: "Page {page} of {totalPages} · {total} items",
      ...
      exceedAvailableLoadListQty: "Quantity cannot exceed remaining load list quantity ({qty})",
      alreadyLinked: "This load list item is already linked to the selected requisition item",
      alreadyPending: "This link is already in the pending list",
      currentLinks: "Current Links",
      alreadyLinkedLabel: "Already linked",
      pendingLabel: "Pending",
      loadListQtyPrefix: "Qty: {qty}",
      unknownItem: "Unknown item",
      unknownReference: "Unknown reference",
      linkAdded: "Link added successfully",
      removeLink: "Remove link",
      removeLinkSuccess: "Link removed successfully",
      removeLinkError: "Failed to remove link",
      loadListNotModifiable: "Only draft or confirmed load lists can be modified",
      ...
      staleLoadListItems:
        "The load list changed before the links were submitted. Review the refreshed items and try again.",
    ...
    grnsPage: {
      ...
      view: "View",
      submit: "Submit",
      submitForApproval: "Submit for Confirmation",
      submitTitle: "Submit GRN for Confirmation",
      submitDescription: "Submit {grnNumber} for confirmation?",
      submitting: "Submitting...",
      submitSuccess: "GRN submitted for confirmation",
      submitError: "Failed to submit GRN",
      submitMissingReceivedQty: "Enter received quantities for all GRN items before submitting.",
      confirm: "Confirm Receive",
      confirmTitle: "Confirm GRN",
      confirmDescription:
        "Are you sure you want to confirm {grnNumber}? This confirms the received stock staged for putaway. This action cannot be undone.",
      confirming: "Confirming...",
      confirmSuccess: "GRN confirmed successfully",
      confirmError: "Failed to confirm GRN",
      delete: "Delete",
    ...
    grnDetailPage: {
      ...
      confirmDescription:
        "Are you sure you want to confirm {grnNumber}? This confirms the received stock staged for putaway. This action cannot be undone.",
      confirmationNotes: "Confirmation Notes (optional)",
      confirmationNotesPlaceholder: "Add any confirmation notes...",
      confirming: "Confirming...",
    ...
    stockRequestsPage: {
      ...
      subtitle: "Manage stock transfers and fulfillment workflow",
      ...
      actions: "Actions",
      loadingError: "Error loading stock transfers. Please try again.",
      ...
      processing: "Processing...",
      submitTitle: "Submit Stock Transfer",
      submitDescription: "Submit this stock transfer for approval?",
      approveTitle: "Approve Stock Transfer",
      approveDescription: "Approve this stock transfer?",
      rejectTitle: "Reject Stock Transfer",
      rejectDescription: "Reject this stock transfer? Please provide a reason.",
      dispatchTitle: "Dispatch Stock Transfer",
      dispatchDescription: "Dispatch picked quantities and post outbound inventory movement?",
      completeTitle: "Complete Stock Transfer",
      completeDescription:
    ...
    stockRequestForm: {
      ...
      createDescription: "Create a new stock transfer",
    ...
    receiveStockRequestDialog: {
      ...
      receiveError: "Failed to receive stock transfer",
    },
    receiveStockRequestValidation: {
  ...
  zh: {
    ...
    adminSettings: {
      ...
      workflowForm: {
        ...
        stockRequestApprovalTitle: "库存调拨审批",
        stockRequestApprovalDescription: "配置库存调拨的审批流程",
        stockRequestRequireApprovalDescription: "库存调拨在处理前需要审批",
        stockRequestApprovalThresholdDescription: "超过该数值的库存调拨需要审批",
    ...
    deliveryNotesPage: {
      ...
      inventoryAvailabilityLoading: "请等待库存可用量加载完成。",
      inventoryAvailabilityError: "无法加载完整的库存可用量。请重试后再创建送货单。",
    ...
    deliveryNoteDetailPage: {
      ...
      voidItem: "作废行项目",
      addItems: "添加商品",
      addItemsDescription: "向此送货单添加可分配的库存调拨商品，并创建新的拣货单。",
      adjustItem: "调整已发运商品",
      ...
      pendingPicking: "待拣货",
      lineVoided: "已作废行",
      searchItems: "搜索库存调拨或商品...",
      noAllocatableItems: "没有可分配的库存调拨商品。",
      requestedQty: "申请数量",
      availableQty: "可分配数量",
      selectQtyToAdd: "添加数量",
    ...
    reorderManagementPage: {
      ...
      activeAlertsSubTab: "有效 ({count})",
      acknowledgedAlertsSubTab: "已确认 ({count})",
      configurationTab: "配置",
      ...
      createStockRequisition: "创建库存请购",
      reorderAlertLineNote: "由补货预警创建",
      severity: "严重程度",
      item: "商品",
      stockLevel: "库存水平",
      policySource: "策略来源",
      ...
      noAcknowledgedAlerts: "没有已确认预警",
      acknowledgedAlertsDescription: "已确认预警会在其预警条件仍然有效时显示在这里。",
      ...
      acknowledgedAt: "确认时间",
      notAvailable: "不适用",
      seasonOverrideSource: "{season} 覆盖",
      itemDefaultSource: "商品默认值",
      seasonConfiguration: "季节配置",
      seasonConfigurationDescription: "定义按日期生效的补货季节。有效季节会按日期自动选择。",
      seasonCode: "季节编码",
      seasonName: "季节名称",
      effectiveFrom: "生效开始",
      effectiveTo: "生效结束",
      ...
      inactive: "停用",
      addSeason: "添加季节",
      createNewSeason: "创建新季节",
      createNewSeasonDescription: "定义一个季节期间，并为特定商品设置自定义补货规则。",
      seasonCodePlaceholder: "例如：SUMMER2024",
      seasonCodeHelp: "此季节的唯一标识",
      seasonNamePlaceholder: "例如：2024 夏季",
      seasonNameHelp: "此季节的描述性名称",
      effectiveFromHelp: "此季节的开始日期",
      effectiveToHelp: "此季节的结束日期",
      priorityHelp: "优先级较高的季节会优先生效",
      seasonActiveHelp: "只有启用的季节会应用补货规则",
      cancel: "取消",
      creating: "创建中...",
      createSeason: "创建季节",
      seasonCodeAndNameRequired: "季节编码和名称为必填项",
      seasonEffectiveDateInvalid: "生效开始日期必须早于或等于生效结束日期",
      seasonPriorityInvalid: "优先级必须为非负数",
      season: "季节",
      effectiveDates: "生效日期",
      itemsOverridden: "覆盖商品",
      actions: "操作",
      status: "状态",
      loading: "加载中",
      loadingSeasons: "正在加载季节...",
      noSeasons: "未配置补货季节",
      noSeasonsConfigured: "未配置季节。请先创建第一个季节。",
      deleteSeason: "删除季节",
      deleteSeasonConfirm: "确定要删除“{name}”吗？这也会删除所有关联的商品策略。",
      seasonalReorderRules: "季节性补货规则",
      seasonalReorderRulesDescription: "在一个位置管理季节及其按商品的补货覆盖规则。",
      newSeason: "新建季节",
      managePolicies: "管理策略",
      seasonPolicyItemCount: "{count} 个商品",
      seasonalItemPolicies: "季节商品策略",
      seasonalItemPoliciesDescription:
        "为季节设置按商品的补货覆盖值。停用的策略会回退到商品默认值。",
      selectSeason: "选择季节",
      selectItem: "选择商品",
      searchItems: "搜索商品",
      noItemsFound: "未找到商品",
      seasonItemPolicyTitle: "{seasonName} - 商品补货策略",
      seasonItemPolicySubtitle: "{seasonCode} - {effectiveFrom} 至 {effectiveTo}",
      reorderLevel: "补货水位",
      reorderLevelPlaceholder: "例如：50",
      reorderQty: "补货数量",
      reorderQuantityPlaceholder: "例如：100",
      reorderQuantity: "补货数量",
      unit: "单位",
      selectUnit: "选择单位",
      qtyPerUnit: "每单位数量",
      baseReorderLevel: "基础补货水位",
      totalQty: "总数量",
      activeOnCreation: "创建时启用",
      createPolicy: "创建策略",
      searchByItemNameOrCode: "按商品名称或编码搜索...",
      allStatus: "全部状态",
      activeOnly: "仅启用",
      inactiveOnly: "仅停用",
      addPolicy: "添加策略",
      clear: "清除",
      clearFilters: "清除筛选",
      policyResultsCount: "显示 {filtered} / {total} 条策略",
      policyTotalCount: "共 {count} 条策略",
      noMatchingPolicies: "未找到匹配的策略",
      adjustPolicyFilters: "请调整搜索或筛选条件",
      noItemPoliciesDefined: "未定义商品策略",
      addPolicyEmptyHint: "点击上方“添加策略”为此季节创建补货覆盖规则",
      save: "保存",
      edit: "编辑",
      close: "关闭",
      policyRequiredFieldsInvalid: "请填写所有必填字段并输入有效值",
      policyQuantityInvalid: "补货水位必须为非负数，补货数量必须为正数",
      reorderLevelInvalid: "补货水位必须为非负数",
      reorderQuantityInvalid: "补货数量必须为正数",
      policyUpdateFailed: "更新策略失败",
      policyDeleteFailed: "删除策略失败",
      deleteItemPolicyConfirm: "确定要删除此商品策略吗？",
      noPolicies: "未配置季节商品策略",
      deletePolicy: "删除策略",
      seasonCreated: "补货季节已创建",
      seasonCreateFailed: "创建补货季节失败",
      policyCreated: "季节补货策略已创建",
      policyCreateFailed: "创建季节补货策略失败",
      seasonAndItemRequired: "请先选择季节和商品",
    },
    purchasingOverviewPage: {
      title: "概览",
      subtitle: "采购的战略与运营概览",
    ...
    purchasingOverviewWidgets: {
      ...
      grnsAwaitingApproval: "等待确认的收货单",
      failedLoadPendingApprovals: "加载待确认数据失败",
      allCaughtUp: "已全部处理！",
      noGrnsAwaitingApproval: "没有等待确认的收货单",
      overdueGrnsAlert: "{count} 个收货单已等待超过 24 小时",
      awaitingApprovalLabel: "等待确认",
      grns: "收货单",
      loadList: "装载单",
      hoursShort: "{count} 小时",
      overdue: "逾期",
    ...
    purchaseOnOrderPage: {
      title: "在订商品",
      subtitle: "查看供应商尚未交付的商品",
      searchPlaceholder: "搜索供应商、请购单号、商品编码或商品名称...",
      statusPlaceholder: "状态",
      supplierPlaceholder: "供应商",
      allStatus: "所有状态",
      allSuppliers: "所有供应商",
      ...
      outstanding: "未交付",
      expectedDelivery: "预计交付",
      expectedFrom: "预计交付开始日期",
      expectedTo: "预计交付结束日期",
      status: "状态",
      actions: "操作",
      view: "查看",
      loadError: "加载在订商品失败。请重试。",
      emptyTitle: "未找到在订商品",
      emptyDescription: "提交库存请购后，供应商待交付商品将显示在此处。",
      noValue: "--",
    },
    stockRequisitionForm: {
      editTitle: "编辑库存请购",
    ...
    reportsPage: {
      ...
      reportSettings: "报表设置",
      pdfPreview: "PDF 预览",
      previewRowCount: "可预览 {count} 行数据",
      generatedAt: "生成时间",
      loadingReportData: "正在加载报表数据...",
      previewPlaceholder: "设置报表筛选条件后，点击“预览”生成 PDF。",
      generatingPreview: "正在生成 PDF 预览...",
      previewDialogTitle: "预览 {report}",
      previewDialogDescription: "设置报表筛选条件，然后在导出或打印前预览生成的 PDF。",
      previewFrameTitle: "{report} PDF 预览",
      valueLabel: "价值",
      ...
      slowMovingProductsName: "滞销商品",
      slowMovingProductsDescription: "识别所选期间内销售低或零销售的有库存商品",
      slowMovingProductsValue: "减少呆滞库存和营运资金占用",
      ...
      customerLedgerName: "客户台账",
      customerLedgerDescription: "包含发票、付款、POS 活动和运行余额的客户账户报表",
      customerLedgerValue: "准确掌握客户余额和催收情况",
      arAgingName: "应收账款账龄",
    ...
    inventoryReportPage: {
      title: "库存报表",
      subtitle: "在当前业务单元范围内，按商品、分类、状态和仓库查看库存余额。",
      filters: "筛选条件",
      itemSearch: "商品搜索",
      searchPlaceholder: "搜索商品编码或商品名称...",
      warehouse: "仓库",
      selectWarehouse: "选择仓库",
      category: "分类",
      stockStatus: "库存状态",
      ...
      descending: "降序",
      inventoryRows: "库存行",
      inventoryRowsDescription: "匹配的商品-仓库库存余额。",
      qtyOnHand: "现有数量",
      qtyReserved: "已分配",
      qtyAvailable: "可用",
      qtyInTransit: "在途",
    ...
    productMovementReportsPage: {
      fastTitle: "畅销商品",
      fastSubtitle: "按所选期间内的销售数量、销售速度和收入排行商品。",
      slowTitle: "滞销商品",
      slowSubtitle: "按所选期间内的低流动或零流动情况排行有库存商品。",
      search: "搜索",
      searchPlaceholder: "搜索商品编码、商品名称或分类...",
      startDate: "开始日期",
      endDate: "结束日期",
      period: "期间",
      category: "分类",
      ...
      pageOfTotal: "第 {page} / {totalPages} 页 • 共 {total} 个商品",
      noValue: "--",
    },
    salesAnalyticsPage: {
      title: "销售分析",
    ...
    customerLedgerReportsPage: {
      title: "客户台账报表",
      subtitle: "查看客户账户活动、付款、POS 销售和运行余额",
      filtersTitle: "报表筛选",
      filtersDescription: "选择客户并按期间或来源类型筛选台账。",
      customerPlaceholder: "选择客户",
      customerSearchPlaceholder: "搜索客户...",
      customerEmpty: "未找到客户",
      ...
      periodCredits: "本期贷方",
      closingBalance: "期末余额",
      chargesCaption: "发票和已结算 POS 销售",
      creditsCaption: "付款和 POS 结算",
      activeInvoicesCaption: "{count} 张未结发票",
      ledgerTitle: "台账分录",
      ledgerSearchPlaceholder: "搜索单据、方式或参考号...",
      selectCustomerTitle: "选择客户以生成台账",
      selectCustomerDescription: "报表只加载所选客户的台账分录，并使用服务端筛选。",
      loadErrorTitle: "无法加载客户台账",
      loadErrorDescription: "请刷新后重试。",
      emptyTitle: "未找到台账活动",
      emptyDescription: "请调整客户、日期、来源或搜索筛选。",
      date: "日期",
      source: "来源",
      document: "单据",
      description: "描述",
    ...
    accountsReceivableAgingReportPage: {
      title: "应收账款账龄",
      subtitle: "按所选日期将未结客户发票余额分组到各账龄区间",
      asOfDate: "截至日期",
      customer: "客户",
      allCustomers: "所有客户",
      customerSearchPlaceholder: "搜索客户...",
      ...
      days90Plus: "90+",
      search: "搜索",
      searchPlaceholder: "搜索发票、客户代码或客户名称...",
      customers: "客户",
      invoices: "发票",
      totalBalance: "应收合计",
      invoiceDate: "发票日期",
      ...
      daysOverdue: "天数",
      balance: "余额",
      pageOfTotal: "第 {page} / {totalPages} 页 • 共 {total} 张发票",
    },
    commissionSummary: {
    ...
    loadListsPage: {
      ...
      confirm: "确认",
      confirmTitle: "确认装载单",
      confirmDescription: "确定要确认 {code} 吗？确认后将无法修改商品。",
      confirming: "确认中...",
      confirmSuccess: "装载单确认成功",
      confirmError: "确认装载单失败",
      delete: "删除",
      deleteTitle: "删除装载单",
      deleteDescription: "确定要删除 {code} 吗？此操作无法撤销，系统将永久移除此装载单。",
      cancel: "取消",
      cancelTitle: "取消装载单",
      cancelDescription: "确定要取消 {code} 吗？此操作无法撤销。",
      cancelBack: "不，返回",
      cancelling: "取消中...",
      confirmCancel: "是，取消",
      cancelSuccess: "装载单取消成功",
      cancelError: "取消装载单失败",
      deleting: "删除中...",
    ...
    linkStockRequisitionsDialog: {
      ...
      searchPlaceholder: "按请购单号、商品编码或商品名称搜索",
      loading: "正在加载可关联的请购商品...",
      previous: "上一页",
      next: "下一页",
      pageOfTotal: "第 {page} 页，共 {totalPages} 页 · {total} 个商品",
      ...
      exceedAvailableLoadListQty: "数量不能超过装载单剩余数量（{qty}）",
      alreadyLinked: "此装载单商品已关联到所选请购商品",
      alreadyPending: "此关联已在待提交列表中",
      currentLinks: "当前关联",
      alreadyLinkedLabel: "已关联",
      pendingLabel: "待提交",
      loadListQtyPrefix: "数量：{qty}",
      unknownItem: "未知商品",
      unknownReference: "未知参考",
      linkAdded: "关联添加成功",
      removeLink: "移除关联",
      removeLinkSuccess: "关联已移除",
      removeLinkError: "移除关联失败",
      loadListNotModifiable: "只有草稿或已确认的装载单可以修改",
      linksRequired: "请至少添加一个关联",
      linkSuccess: "成功将 {count} 个商品关联到请购",
      linkError: "关联请购失败",
      staleLoadListItems: "提交关联前装载单已发生变化。请检查刷新后的商品并重试。",
      pendingLinks: "待提交关联",
      noLinksTitle: "尚未添加关联",
    ...
    grnsPage: {
      ...
      view: "查看",
      submit: "提交",
      submitForApproval: "提交确认",
      submitTitle: "提交收货单确认",
      submitDescription: "提交 {grnNumber} 确认？",
      submitting: "提交中...",
      submitSuccess: "收货单已提交确认",
      submitError: "提交收货单失败",
      submitMissingReceivedQty: "提交前请为所有收货单商品输入收货数量。",
      confirm: "确认收货",
      confirmTitle: "确认收货单",
      confirmDescription:
        "确定要确认 {grnNumber} 吗？这将确认已暂存到上架区的收货库存。此操作无法撤销。",
      confirming: "确认中...",
      confirmSuccess: "收货单确认成功",
      confirmError: "确认收货单失败",
      delete: "删除",
      deleteTitle: "删除收货单",
      deleteDescription: "确定要删除 {code} 吗？此操作无法撤销，系统将永久移除此收货单。",
      cancel: "取消",
    ...
    grnDetailPage: {
      ...
      confirmDescription:
        "确定要确认 {grnNumber} 吗？这将确认已暂存到上架区的收货库存。此操作无法撤销。",
      confirmationNotes: "确认备注（可选）",
      confirmationNotesPlaceholder: "添加确认备注...",
      confirming: "确认中...",
    ...
    stockRequestsPage: {
      title: "库存调拨",
      subtitle: "管理库存调拨及履行流程",
      deliveryNotes: "送货单",
      createRequest: "创建申请",
      searchPlaceholder: "搜索库存调拨...",
      statusPlaceholder: "状态",
      ...
      processing: "处理中...",
      submitTitle: "提交库存调拨",
      submitDescription: "确定要提交此库存调拨以供审批吗？",
      approveTitle: "批准库存调拨",
      approveDescription: "确定要批准此库存调拨吗？",
      rejectTitle: "拒绝库存调拨",
      rejectDescription: "确定要拒绝此库存调拨吗？请提供原因。",
      dispatchTitle: "发运库存调拨",
      dispatchDescription: "发运已拣货数量并过账出库库存移动吗？",
      completeTitle: "完成库存调拨",
    ...
    receiveStockRequestDialog: {
      ...
      receiveSuccess: "库存调拨接收成功。",
      receiveError: "接收库存调拨失败",
    },
    receiveStockRequestValidation: {
