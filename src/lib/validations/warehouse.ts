...
export const warehouseFormSchema = z.object({
  ...
  description: z
    ...
    .optional()
    .default(""),
  address: z.string().max(500, "Address must be less than 500 characters").optional().default(""),
  city: z.string().max(100, "City must be less than 100 characters").optional().default(""),
  state: z.string().max(100, "State must be less than 100 characters").optional().default(""),
  postalCode: z
    .string()
    .max(20, "Postal code must be less than 20 characters")
    .optional()
    .default(""),
  country: z.string().max(100, "Country must be less than 100 characters").optional().default(""),
