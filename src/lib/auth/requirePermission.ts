 ...
 */
export async function requireView(resource: Resource): Promise<UnauthorizedResponse | null> {
  return requirePermission(resource, "view");
}

export async function requireCreate(resource: Resource): Promise<UnauthorizedResponse | null> {
  return requirePermission(resource, "create");
}

export async function requireEdit(resource: Resource): Promise<UnauthorizedResponse | null> {
  return requirePermission(resource, "edit");
}

export async function requireDelete(resource: Resource): Promise<UnauthorizedResponse | null> {
