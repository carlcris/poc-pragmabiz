...
const NAVIGATION_PAGES: NavigationPageDefinition[] = [
  ...
  {
    pageKey: "inventory.transformations.templates.design",
    title: "Transformation Template Designer",
    match: /^\/inventory\/transformations\/templates\/design$/,
  },
  {
    pageKey: "inventory.transformations.templates",
    title: "Transformation Templates",
    match: /^\/inventory\/transformations\/templates$/,
  },
  {
    pageKey: "inventory.transformations.new",
    title: "New Stock Transformation",
    match: /^\/inventory\/transformations\/new$/,
  },
  {
    pageKey: "inventory.transformations.detail",
    title: "Stock Transformation Details",
    match: /^\/inventory\/transformations\/[^/]+$/,
  },
  {
    pageKey: "inventory.transformations",
